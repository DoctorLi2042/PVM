...
const Header: FC = () => {
  ...
  return (
    <header>
      <div className="hold"><a href="https://github.com/DoctorLi2042/PVM"><GitHubIcon sx={{ color: '#007FFF' }}/></a></div>
      <h1>PVM demo<span>{nowChain.length > 0 ? nowChain[0].name : ''}</span></h1>
      <Button
        className="connect"
        variant="text"
        onClick={() => {
