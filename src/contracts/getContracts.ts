...
import PVMABI from "./ABI/PVM.json";
import { useWeb3React } from "@web3-react/core";
import { JsonRpcSigner, Web3Provider } from "@ethersproject/providers";
import { useMemo } from "react";
import { AddressesType, NESTPVMAddress, NESTTokenAddress } from "../libs/addresses";
...
export function usePVMContract(): Contract | null {
  return useContract(NESTPVMAddress, PVMABI)
}

export function useNESTContract(): Contract | null {
  return useContract(NESTTokenAddress, ERC20ABI)
}
